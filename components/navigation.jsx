		...
		<>
				...
				>
					<Link href={routes.home} passHref={true}>
						<div
							className={`w-1/4 py-6 ${
								active == routes.home
									? "bg-white"
									: "bg-slate-300 hover:bg-slate-400 navInnerShadow"
							} ${
					...
					<Link href={routes.statistics} passHref={true}>
						<div
							className={`w-1/4 py-6 ${
								...
								prevElem == routes.statistics
									? "rounded-tr-3xl"
									: ""
							} ${
								afterElem == routes.statistics
									? "rounded-tl-3xl"
									: ""
							}`}
						>
					...
					<Link href={routes.friends} passHref={true}>
						<div
							className={`w-1/4 py-6 ${
								active == routes.friends
									? "bg-white"
									: "bg-slate-300 hover:bg-slate-400 navInnerShadow"
							} ${
								prevElem == routes.friends
									? "rounded-tr-3xl"
									: ""
							} ${
								afterElem == routes.friends
									? "rounded-tl-3xl"
									: ""
							}`}
						>
					...
					<Link href={routes.settings} passHref={true}>
						<div
							className={`w-1/4 py-6 ${
								...
								prevElem == routes.settings
									? "rounded-tr-3xl"
									: ""
							} ${
								afterElem == routes.settings
									? "rounded-tl-3xl"
									: ""
							}`}
						>
